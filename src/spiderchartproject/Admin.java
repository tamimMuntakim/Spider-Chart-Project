...
public class Admin extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        setBounds(new java.awt.Rectangle(450, 200, 732, 418));
        setResizable(false);

        jPanel1.setBackground(new java.awt.Color(255, 255, 255));
        jPanel1.setPreferredSize(new java.awt.Dimension(723, 418));

        jButton2.setBackground(new java.awt.Color(51, 153, 255));
        jButton2.setFont(new java.awt.Font("Segoe UI", 1, 13)); // NOI18N
        jButton2.setForeground(new java.awt.Color(255, 255, 255));
        jButton2.setText("Remove admin/student");
        ...
        jButton3.setText("Add new admin/student");
        ...
        jButton4.setText("Modify student's marks");
        ...
        jLabel2.setText("Welcome " + User.getAccess() +": " + User.getName());

        jLabel3.setIcon(new javax.swing.ImageIcon(getClass().getResource("/admin1-fotor-2023102114440.png"))); // NOI18N
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        String s = ChangePassword.changePassword();
        if (s != null) {
            if (s.isEmpty()) {
                JOptionPane.showMessageDialog(null, "Blank-space cannot be password");
            } else {
                try {
                    Connection conn = DbConnection.getConnection();
                    String query = "update users set password=\'" + s + "\' where username = \'" + User.getUname() + "\' and access = \'" + User.getAccess() + "\'";
    ...
    private void jButton4ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton4ActionPerformed
        new SemesterCombo().setVisible(true);
