...
public class LoginPage extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        setTitle("Login Page");
        setBounds(new java.awt.Rectangle(450, 200, 723, 418));
        setResizable(false);

        jPanel1.setBackground(new java.awt.Color(51, 153, 255));

        jLabel6.setIcon(new javax.swing.ImageIcon(getClass().getResource("/kisspng-computer-icons-login-management-user-5ae155f3386149.6695613615247170432309-fotor-20231020223714.png"))); // NOI18N
        ...
        jTextField1.setBackground(new java.awt.Color(246, 250, 250));
        ...
        jPasswordField1.setBackground(new java.awt.Color(246, 250, 250));
        ...
        jLabel4.setText("Enter your password here......");

        jComboBox1.setBackground(new java.awt.Color(250, 250, 250));
        jComboBox1.setFont(new java.awt.Font("Berlin Sans FB", 0, 13)); // NOI18N
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        try {
            ...
            String query = "select * from users where username=\'" + uname + "\' and password=\'" + password + "\' and access=\'" + access + "\'";
